((globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
	...
	{
		otherChunks: [
			'static/chunks/fe05f79d03cc9274.js',
			'static/chunks/806bdb8e4a6a9b95.js',
			'static/chunks/349e72174ed0df63.js',
			'static/chunks/0afa5e999b6c353a.js'
		],
		runtimeModuleIds: [94553]
	}
]),
	(() => {
		let e;
		...
		function f(e, t) {
			(u(e, '__esModule', { value: !0 }), s && u(e, s, { value: 'Module' }));
			let r = 0;
			for (; r < t.length;) {
				let n = t[r++],
					o = t[r++];
				if ('number' == typeof o)
					if (0 === o) u(e, n, { value: t[r++], enumerable: !0, writable: !1 });
					else throw Error(`unexpected tag: ${o}`);
				else
					'function' == typeof t[r]
						? u(e, n, { get: o, set: t[r++], enumerable: !0 })
						: u(e, n, { get: o, enumerable: !0 });
			}
			Object.seal(e);
		}
		((l.s = function (e, t) {
		...
		function d(e, t, r) {
			let n = [],
				o = -1;
			for (let t = e; ('object' == typeof t || 'function' == typeof t) && !h.includes(t); t = p(t))
			...
			return (
				(r && o >= 0) || (o >= 0 ? n.splice(o, 1, 0, e) : n.push('default', 0, e)),
				f(t, n),
				t
			);
		}
		...
		l.a = function (e, t) {
			let r = this.m,
				...
				o = new Set(),
				{ resolve: l, reject: i, promise: s } = y(),
				u = Object.assign(s, {
					[g]: r.exports,
					[O]: (e) => {
...
importScripts(...self.TURBOPACK_NEXT_CHUNK_URLS.map(c => self.TURBOPACK_WORKER_LOCATION + c).reverse());`
		...
		function q(e, t, r) {
			...
			return (
				l.namespaceObject && l.exports !== l.namespaceObject && d(l.exports, l.namespaceObject),
				l
			);
		}
		function I(r) {
			let n,
				o = (function (e) {
					...
					let r = decodeURIComponent(
						('u' > typeof TURBOPACK_NEXT_CHUNK_URLS
					...
					: ((n = void 0),
						!(function (e, t, r, n) {
							...
							for (; o < e.length;) {
								...
								if (!r.has(t)) {
									let l = e[n];
									for (Object.defineProperty(l, 'name', { value: 'module evaluation' }); o < n; o++)
										((t = e[o]), r.set(t, l));
								}
								o = n + 1;
							}
		...
		e = {
			async registerChunk(e, t) {
				if ((H(K(e)).resolve(), null != t)) {
					...
					if (
						(await Promise.all(t.otherChunks.map((t) => S(0, e, t))), t.runtimeModuleIds.length > 0)
					)
						for (let r of t.runtimeModuleIds)
							!(function (e, t) {
								let r = L[t];
								if (r) {
									if (r.error) throw r.error;
		...
		((globalThis.TURBOPACK = { push: I }), F.forEach(I));
	})());
(function () {
	if (
	...
	s.setAttribute('data-deployment-id', 'dpl_C8gnQSp2d3uWrLJpbmkxDRkcSSV6');
