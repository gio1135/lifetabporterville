(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
	...
	(e, t, r) => {
		...
		function l({ notFound: e, forbidden: t, unauthorized: r, children: n }) {
	...
	(e, t, r) => {
		...
		let n = e.r(71645);
		function a(e, t) {
			let [r, a] = (0, n.useState)(() => ({ tree: e, stateKey: t, next: null }));
			if (r.tree === e) return r;
			let o = { tree: e, stateKey: t, next: null },
				i = 1,
				s = r,
				c = o;
			for (; null !== s && i < 1;) {
				...
				{
					i++;
					let e = { tree: s.tree, stateKey: s.stateKey, next: null };
					((c.next = e), (c = e));
				}
				s = s.next;
			}
	...
	(e, t, r) => {
					...
					(this.handlePotentialScroll = () => {
						...
						if (e.apply) {
							if (
								...
								!e.segmentPaths.some((e) => t.every((t, r) => (0, d.matchSegment)(t, e[r])))
							)
								return;
							let r = null,
								n = e.hashFragment;
							if (
								...
								r || (r = 'u' < typeof window ? null : (0, _.findDOMNode)(this)),
		...
		function R({ segmentPath: e, children: t }) {
			...
			return (0, o.jsx)(O, { segmentPath: e, focusAndScrollRef: r.focusAndScrollRef, children: t });
		}
		function E({
			tree: e,
			segmentPath: t,
			...
			let d,
				f = (0, i.useContext)(c.GlobalLayoutRouterContext);
			if (((0, i.useContext)(y.NavigationPromisesContext), !f))
				throw Object.defineProperty(
					Error('invariant global layout router not mounted'),
					'__NEXT_ERROR_CODE',
					{ value: 'E473', enumerable: !1, configurable: !0 }
		...
		function j({ name: e, loading: t, children: r }) {
			let n;
			if (
				(n = 'object' == typeof t && null !== t && 'function' == typeof t.then ? (0, i.use)(t) : t)
			) {
				let t = n[0],
					a = n[1],
					s = n[2];
				return (0, o.jsx)(i.Suspense, {
					name: e,
					fallback: (0, o.jsxs)(o.Fragment, { children: [a, s, t] }),
					children: r
				});
			}
		...
		class u {
					...
					e &&
						(e.addEventListener(
							...
							() => {
								let { reason: t } = e;
								(this.currentStage < 3 &&
									(this.runtimeStagePromise.promise.catch(l), this.runtimeStagePromise.reject(t)),
			...
			onStage(e, t) {
				if (this.currentStage >= e) t();
					...
					throw Object.defineProperty(
						new i.InvariantError(`Invalid render stage: ${e}`),
						'__NEXT_ERROR_CODE',
							...
							get(e, t, r) {
								...
								if ('string' == typeof t && 'then' === t) {
									...
									l.dynamicShouldError
										? (0, f.throwWithStaticGenerationBailoutErrorWithDynamicError)(l.route, e)
										: 'prerender-ppr' === d.type
											? (0, i.postponeWithTracking)(l.route, e, d.dynamicTracking)
											: (0, i.throwToInterruptStaticGeneration)(e, l, d);
								}
								return o.ReflectAdapter.get(e, t, r);
							}
						});
				...
				n = new Proxy(r, {
					get: function t(n, a, i) {
						return (
							Object.hasOwn(r, a) ||
								'string' != typeof a ||
								('then' !== a && d.wellKnownProperties.has(a)) ||
								(0, f.throwForSearchParamsAccessInUseCache)(e, t),
							o.ReflectAdapter.get(n, a, i)
						);
					}
				});
			return (_.set(e, n), n);
						...
						for (let a in e)
							if (n.has(a))
								return (function (e, t, r) {
									...
									if (n) return n;
									let a = new Proxy(
										(0, d.makeHangingPromise)(r.renderSignal, t.route, '`params`'),
										v
									);
									return (S.set(e, a), a);
								})(e, t, r);
								...
								return (function (e, t, r, n) {
									...
									return (
										...
										Object.keys(e).forEach((e) => {
											l.wellKnownProperties.has(e) ||
												(t.has(e) &&
													Object.defineProperty(o, e, {
														get() {
															let t = (0, l.describeStringPropertyAccess)('params', e);
															'prerender-ppr' === n.type
																? (0, s.postponeWithTracking)(r.route, t, n.dynamicTracking)
																: (0, s.throwToInterruptStaticGeneration)(t, r, n);
														},
														enumerable: !0
													}));
										}),
	...
	(e, t, r) => {
		...
		let n = e.r(43476),
			...
			s = e.r(33906),
			c = e.r(61994);
		function u({ Component: t, serverProvidedParams: r }) {
			let u, l;
			if (null !== r) ((u = r.searchParams), (l = r.params));
			else {
				let e = (0, i.use)(o.LayoutRouterContext);
				((l = null !== e ? e.parentParams : {}),
					(u = (0, s.urlSearchParamsToParsedUrlQuery)((0, i.use)(c.SearchParamsContext))));
			}
			if ('u' < typeof window) {
				let r,
					o,
					{ workAsyncStorage: i } = e.r(63599),
					s = i.getStore();
				if (!s)
					throw Object.defineProperty(
				...
				let { createSearchParamsFromClient: c } = e.r(69882);
				r = c(u, s);
				let { createParamsFromClient: d } = e.r(41489);
				return ((o = d(l, s)), (0, n.jsx)(t, { params: o, searchParams: r }));
			}
			{
	...
	(e, t, r) => {
		...
		let n = e.r(43476),
			...
			o = e.r(8372),
			i = e.r(71645);
		function s({ Component: t, slots: r, serverProvidedParams: s }) {
			let c;
			...
			if ('u' < typeof window) {
				...
				let { createParamsFromClient: u } = e.r(41489);
				return ((o = u(c, s)), (0, n.jsx)(t, { ...r, params: o }));
			}
			{
