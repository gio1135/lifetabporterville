(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
	...
	(e, t, r) => {
		...
		let n = e.r(43476),
			...
			i = { fontSize: '14px', fontWeight: 400, lineHeight: '28px', margin: '0 8px' },
			s = function ({ error: e }) {
				let t = e?.digest;
								...
								(0, n.jsx)('div', {
									...
									children: (0, n.jsxs)('div', {
										children: [
											...
											t ? (0, n.jsx)('p', { style: i, children: `Digest: ${t}` }) : null
										]
									})
								})
							]
		...
		var n = {
				229: function (e) {
					...
					var c = [],
						...
						a = -1;
					function f() {
						l && n && ((l = !1), n.length ? (c = n.concat(c)) : (a = -1), c.length && p());
					}
					function p() {
						if (!l) {
							var e = s(f);
							...
							case 'object':
								switch (t.$$typeof) {
									...
									case u:
										...
										break;
									case y:
										return e((p = t._init)(t._payload), r, n, i, s);
								}
						}
					if (p)
						return (
