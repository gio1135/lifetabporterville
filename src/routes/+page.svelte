...
>
	...
	>
		...
		{#if isMenuOpen}
			...
			>
				<a
					href="/schedule"
					onclick={toggleMenu}
					class="text-3xl font-light tracking-widest text-white">Schedule</a
				>
				<a
					href="/history"
					onclick={toggleMenu}
					class="text-3xl font-light tracking-widest text-white">History</a
				>
				<a
					href="/doctrine"
					onclick={toggleMenu}
					class="text-3xl font-light tracking-widest text-white">What we believe</a
				>
			</div>
		{/if}

		<div
			class="relative z-10 flex h-full w-full flex-col items-center justify-center px-4 pt-20 pb-20 text-center"
		>
			<h1 class="mb-6 text-5xl font-light tracking-widest text-white md:text-8xl">
				Life Tabernacle
			</h1>
			<p class="mb-12 text-xl font-light tracking-wide text-sand md:text-3xl">
				Where the Bible is believed and obeyed
			</p>
		</div>
		...
		>
			<div
				class="animate-scroll-line h-8 w-full bg-linear-to-b from-transparent via-white to-transparent"
			></div>
		</div>
	</section>
	...
	<section id="stay" bind:this={featuresContainer} class="relative h-[300dvh] w-full shrink-0">
			...
			>
				...
				>
					...
					<p class="max-w-lg text-xl leading-relaxed text-sand/80">
						We believe the Bible is the inspired, infallible, inerrant Word of the living God.
						Everything at Life Tabernacle is rooted directly in scripture
					</p>
				</div>
				<div
		...
		<div
			bind:this={trigger2}
			class="pointer-events-none absolute top-[100dvh] h-dvh w-full snap-start snap-always"
		></div>
		<div
			bind:this={trigger3}
			class="pointer-events-none absolute top-[200dvh] h-dvh w-full snap-start snap-always"
		></div>
	</section>
	...
	>
		<div class="foldable-padding mx-auto w-full max-w-4xl">
			<h2 class="mb-16 text-center text-4xl font-light text-white md:text-left md:text-6xl">
				Answers
			</h2>
			...
			<div class="grid grid-cols-1 gap-12 md:grid-cols-2">
				<div class="flex flex-col space-y-8">
					...
					<div>
						...
						<div class="flex items-center justify-center gap-4 md:justify-start">
							<a
								href="tel:+15597818068"
								class="text-lg text-sand/70 transition-colors hover:text-white"
							>
								(559) 781-8068
							</a>
							<button
